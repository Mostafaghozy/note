...
import '../../logic/create_note_cubit/cubit.dart';
import '../../logic/create_note_cubit/state.dart';
...
class CreateNoteScreen extends StatelessWidget {
  ...
  XFile? selectedImage; //XFile = Data_Type

  Future selectImage() async {
    final ImagePicker picker = ImagePicker(); //picker=object
  ...
  Future<String?> uploadImage(XFile image) async {
    try {
      ...
      //  open file => name file >>note_images/  ____ Name Image has >>> ${DateTime.now().millisecondsSinceEpoch}.jpg
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                                fillColor: ColorsManger.lightPurple,
                                filled: true,
                    ...
                    InkWell(
                      onTap: () async {
                        if (selectedImage != null) {
                          ...
                          // when upload note without image ..
                          context.read<CreateNoteCubit>().createNote(NotesModel(
                                description: descriptionController.text,
                                headline: headLineController.text,
                                time: DateTime.now(),
